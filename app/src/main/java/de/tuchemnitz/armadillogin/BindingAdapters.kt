...
fun bindText(
    ...
    textContent: List<HelpData>,
    viewContext: FragmentActivity,
    armadilloViewModel: ArmadilloViewModel,
    lifecycleOwner: LifecycleOwner
) {
    recyclerView.adapter =
        HelpItemAdapter(viewContext, textContent, armadilloViewModel, lifecycleOwner)
